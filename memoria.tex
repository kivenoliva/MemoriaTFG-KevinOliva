...
Una vez que hemos echado un vistazo a los datos totales que hemos analizado, vamos a centrarnos en los distintos repositorios que hemos utilizado para nuestro estudio. Tenemos el siguiente listado: FIXME: esto debería ser una tabla, la tabla~\ref{tab:proyectos}.

\begin{table}[]
\centering
\caption{Proyectos Analizados}
\label{tab:proyectos}
\begin{tabular}{|l|r|r|r|r|r|}
 \hline
Proyecto & Verdes & Naranjas & Rojas & Rojas Comentarios  & Totales  \\ \hline \hline
youtube-dl & 112.898 & 6.332 & 8.507 & 5 (0,058\%) &  127.737 \\ \hline
 &  &  &  &  & \\ \hline
 &  &  &  &  & \\ \hline 
\end{tabular}
\end{table}
...
\begin{itemize}
	...
	FIXME: cambiar esta parte para que se vea mejor. Por ejemplo, como esto de abajo y no como lo siguiente.
