...
Programming languages usually have a style guide that indicates, among other things, how to format the code. This project aims to conduct a study on the use of one of the rules contained in the Python style guide named PEP8\footnote{\url{http://pythonwiki.wikispaces.com/pep8}}.
...
Node.js~\cite{Node.js} es una librería y entorno de ejecución de E/S dirigida por eventos y por lo tanto, asíncrona que se ejecuta sobre el intérprete de JavaScript creado por Google V8. El logo de Node.js se muestra en la figura~\ref{fig:node}.
