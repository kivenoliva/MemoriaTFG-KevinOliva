...
Una vez que hemos echado un vistazo a los datos totales que hemos analizado, vamos a centrarnos en los distintos repositorios que hemos utilizado para nuestro estudio. Tenemos el siguiente listado:
...
Como podemos ver, hemos utilizado repositorios distintos tanto en tamaño como en características. Me llaman la atención algunos datos.

Como es de esperar, en todos los repositorios, la gran mayoría de líneas son verdes.

Sólo hemos encontrado un repositorio que no tenga líneas rojas, y tampoco podemos tenerlo muy en cuenta ya que solo tiene 38 líneas en total.

Tenemos 5 repositorios en los que hay más líneas naranjas que rojas, 5 repositorios en los que hay más líneas rojas que naranjas, y un repositorio en el que hay las mismas líneas rojas que naranjas. Estos datos no nos dejan sacar ninguna conclusión sobre esto ya que son demasiado igualados, aunque si que es cierto que en el recuento total, tenemos más líneas naranjas que rojas.
