...
\begin{figure}
	\centering
	\includegraphics[scale=0.75]{img/diagramaBarras}
...
Como podemos ver son uno porcentajes bajísimos. Si analizamos esas 396 líneas, y las clasificamos según su motivo, de la forma que ya explicamos en el capítulo 4 (véase la sección~\ref{sec:clasificacion-de-lineas-conflictivas}), obtenemos el siguiente resultados\footnote{Se ha omitido la indentación de las líneas para que quepan en el ancho de página.}:
